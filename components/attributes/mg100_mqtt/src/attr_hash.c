...
/* Command-line: 'C:\\ProgramData\\chocolatey\\lib\\gperf\\tools\\gperf.exe' -C -c -G -D -t -T --word-array-name=word_list --lookup-function-name=attr_id_from_hash --hash-function-name=gperf_hash --output-file='components\\attributes\\mg100_mqtt\\src\\attr_hash.c' 'components\\attributes\\mg100_mqtt\\src\\attr.gperf'  */
